...
\footnotetext{Available at: \href{https://archive.ics.uci.edu/ml/datasets/Iris}{archive.ics.uci.edu/ml/datasets/Iris}}
...
\footnotetext{Available at: \href{https://archive.ics.uci.edu/ml/datasets/ILPD+(Indian+Liver+Patient+Dataset)}{archive.ics.uci.edu/ml/ILPD}}
...
\begin{figure}[H]
	...
	\caption{The Torus, a manifold often studied in topology \protect\footnotemark.}
	\label{fig:mani_torus}
\end{figure}

\footnotetext{Available at: \href{Weisstein, Eric W. "Torus." From MathWorld--A Wolfram Web Resource. http://mathworld.wolfram.com/Torus.html}{mathworld.wolfram.com/Torus}}
...
\footnotetext{Available at: \href{https://en.wikipedia.org/wiki/Manifold}{wiki/Manifold/Charts}}
