...
Figure \ref{fig:comparison_oriiso_skiso} displays the reduction of the Swiss-roll data set done by the original implementation of ISOMAP (using MDS) and scikit-learn's implementation (using Kernel PCA). Numerically, they are identical (i.e., save from difference $\delta \to 0$).
