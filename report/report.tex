...
This project aims to study the foundations of nonlinear dimensionality reduction through manifold learning with the algorithm known as Isometric Feature Mapping (or simply ISOMAP) and observe the application of the algorithm in practical experiments.
...
\paragraph{ISOMAP as a variation of Kernel PCA}
...
In conclusion, we have observed that although its limitations, ISOMAP is, indeed, a very regarded method in manifold learning, being cited by many authors since its first presentation and being implemented in many different machine learning libraries, languages and computational environments. Additionally, we can also infer its popularity by the high load of work done trying to improve and extend ISOMAP.
