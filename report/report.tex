...
With 366 samples, 35 features, the Dermatology data set is illustrated by the following figure:
\begin{figure}[H]
	\centering
	\includegraphics[width=.5\linewidth]{datasets/dermatology}
	\captionsetup{justification=centering}
...
\begin{figure}[H]
	...
	\captionsetup{justification=centering}
	\caption{The Dermatology data set reduced to 20, 10, 3 and 2 dimensions, respectively.}
\end{figure}
