...
\begin{enumerate} 
	...
	\begin{enumerate}
		...
		\begin{align*}
			y &= -\frac{1}{n} L^{-1}  (\Delta_x - \bar{\Delta}_n)\\		
			y &= -\frac{1}{n} \colvec{4}{\frac{v_1^T}{\sqrt{\lambda_1}}}{\frac{v_2^T}{\sqrt{\lambda_2}}}{\dots}{\frac{v_n^T}{\sqrt{\lambda_n}}} (\Delta_x - \bar{\Delta}_n)\\
		\end{align*}
