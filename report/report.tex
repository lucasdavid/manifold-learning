...
\bibitem{ren2010}
A. H. Renear, S. Sacchi and K. M. Wickett (2010),
``Definitions of Dataset in the Scientific and Technical Literature."
{\em ASIS\&T 2010}, 2010. Available:
\url{https://www.asis.org/asist2010/proceedings/proceedings/ASIST_AM10/openpage.html} [15 Sept. 2015]

\bibitem{cay2005}
L. Cayton,
``Algorithms for manifold learning."
San Diego, CA, USA: University of California: San Diego,
Jun. 15, 2005. Available:
\url{http://www.vis.lbl.gov/~romano/mlgroup/papers/manifold-learning.pdf} [Aug. 25, 2015]

\bibitem{gho2006}
A. Ghodsi (2006),
{\em Dimensionality Reduction A Short Tutorial.}
University of Waterloo. Available:
\url{http://www.math.uwaterloo.ca/~aghodsib/courses/f06stat890/readings/tutorial_stat890.pdf} [Aug. 25, 2015]

\bibitem{cox2001}
T.F. Cox and M. A. A. Cox,
{\em Multidimensional Scaling}, 2nd ed.
Boca Raton, FL, USA: CRC Press, 2000.

\bibitem{gan2008}
W. Gander. (2008 Dec. 12),
{\em The Singular Value Decomposition} [Online]. Available: \url{https://www2.math.ethz.ch/education/bachelor/lectures/hs2014/other/linalg_INFK/svdneu.pdf}
	
\bibitem{lee2009}
J. M. Lee,
``Differentiable Manifolds" in {\em Manifolds and Differential Geometry}, vol. 107.
Providence, RI, USA: American Mathematical Soc., 2009.

\bibitem{lee2012}
J. M. Lee,
``Smooth Manifolds" in {\em Introduction to Smooth Manifolds}, vol. 218.
New York, NY, USA: Springer Science \& Business Media, 2012.

\bibitem{stereo_proj}
E. W. Weisstein,
``Stereographic Projection."
Available: \url{http://mathworld.wolfram.com/StereographicProjection.html} [Oct. 21, 2015].

\bibitem{berge1973}
C. Berge,
{\em Graphs and Hypergraphs}, 6th ed.
Amsterdam, Netherlands: North-Holland Publishing Company, 1973.

\bibitem{may1972}
W. Mayeda,
{\em Graph Theory}.
Hoboken, NJ, USA: John Wiley \& Sons, 1972.

\bibitem{cor2011}
T. H. Cormen, C. E Leiserson, R. L. Rivest and C. Stein,
{\em Introduction To Algorithms}, 2nd ed.
Cambridge, MA, USA: MIT Press, 2001, pp. 580-642.

\bibitem{pat1996}
P. Langley,
{\em Elements of Machine Learning}, vol. I.
San Francisco, CA, USA: Morgan Kaufmann, 1996.

\bibitem{hot2009}
L. W. Hosch,
``Machine Learning." {\em Encyclopedia Britannica}. [Online].
Available: \url{http://global.britannica.com/technology/machine-learning/article-history}, Dec. 8, 2014 [Aug. 8, 2015].

\bibitem{awa2015}
M. Awad and R. Khanna,
{\em Efficient Learning Machines: Theories, Concepts, and Applications for Engineers and System Designers.}
New York, NY, USA: Apress, 2015. [E-book] Available: Amazon.

\bibitem{zhu2009}
X. Zhu and A. B. Goldberg,
{\em Introduction to Semi-Supervised Learning.}
San Rafael, CA, USA: Morgan \& Claypool Publishers, 2009.

\bibitem{sksvm}
``SVM: Maximum margin separating hyperplane."
{\em scikit-learn}. [Online]. Available: \url{http://scikit-learn.org/stable/auto_examples/svm/plot_separating_hyperplane.html} [20 Sept. 2015].

\bibitem{mitsvm}
P. Winston,
6.034 Artificial Intelligence. Class Lecture, Topic: ``Learning: Support Vector Machine."
Massachusetts Institute of Technology, 2010. Available:
\url{https://www.youtube.com/watch?v=_PwhiWxHK8o} [20 Sept. 2015]
...
Available: \url{http://www.cs.columbia.edu/~kathy/cs4701/documents/jason_svm_tutorial.pdf}.

\bibitem{svmkernels}
C. D. Manning, P. Raghavan and H. Schutze,
{\em An Introduction to Information Retrieval}.
Cambridge, MA, USA: Cambridge University Press, 2009. [E-book]
Available: \url{http://nlp.stanford.edu/IR-book/pdf/irbookonlinereading.pdf}

\bibitem{rif2008}
R. Rifkin,
9.520 Class 06. Class Lecture, Topic: ``Multiclass Classification."
Massachusetts Institute of Technology, Feb. 25, 2008. Available:
\url{http://www.mit.edu/~9.520/spring09/Classes/multiclass.pdf} [Sept. 20, 2015]

\bibitem{ovacj}
``SVM Multi-Class Classification,"
Technische Universität München. Available:
\url{https://www.sec.in.tum.de/assets/lehre/ws0910/ml/slideslecture9.pdf} [Sept. 20, 2015]

\bibitem{crossvalid}
``Cross-validation: evaluating estimator performance,"
{\em scikit-learn}. [Online]. Available:
\url{http://scikit-learn.org/stable/modules/cross_validation.html} [Aug. 23, 2015]

\bibitem{gridsearch}
``Grid Search: Searching for estimator parameters,"
{\em scikit-learn}. [Online]. Available:
\url{http://scikit-learn.org/stable/modules/grid_search.html} [Aug. 23, 2015]

\bibitem{roh2015}
B. Rohrer,
``How to choose algorithms for Microsoft Azure Machine Learning."
{\em Microsoft Azure, 2005}. [Online]. Available:
\url{https://azure.microsoft.com/en-us/documentation/articles/machine-learning-algorithm-choice} [Sept. 10, 2015]

\bibitem{pca1989}
G. H. Dunteman,
{\em Principal Components Analysis.}, vol. 69.
Newbury Road, CA, USA: Sage, 1989.

\bibitem{pca2002}
L. I. Smith,
``A tutorial on Principal Components Analysis.", 2002.
Available: \url{http://www.cs.otago.ac.nz/cosc453/student_tutorials/principal_components.pdf}

\bibitem{pcajon2003}
J. Shlens,
``A Tutorial on Principal Component Analysis: Derivation, Discussion and Singular Value Decomposition."
Mar. 25, 2003.
Available: \url{https://www.cs.princeton.edu/picasso/mats/PCA-Tutorial-Intuition_jp.pdf} [Oct. 9, 2015]

\bibitem{pcapy}
S. Raschka,
``Implementing a Principal Component Analysis (PCA) in Python step by step."
Apr. 13, 2014. [Online].
Available: \url{http://sebastianraschka.com/Articles/2014_pca_step_by_step.html} [Oct. 9, 2015]

\bibitem{ten2000}
T. B. Joshua, V. Silva and J. C. Langford,
``A Global Geometric Framework for Nonlinear Dimensionality Reduction."
{\em Science}, vol. 290, pp. 2319-2323. Dec. 22, 2000.

\bibitem{herik2009}
L. Maaten, E. Postma and J. Herik,
``DimensionalityReduction: A Comparative Review."
