...
In order to visualize this issue, consider the following experiment: let \textbf{Spam} be a data set with 4601 samples and 57 features and implementations MDS, Isomap, sk-PCA and sk-Isomap (the last two being native algorithms from the \href{http://scikit-learn.org}{scikit-learn} library).
